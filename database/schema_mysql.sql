...
-- If upgrading an EXISTING database, run these ALTER statements first:
--   ALTER TABLE departments_ministries
--     ADD COLUMN IF NOT EXISTS logo_path VARCHAR(255) DEFAULT NULL,
--     ADD COLUMN IF NOT EXISTS chair_name VARCHAR(150) DEFAULT NULL,
--     ADD COLUMN IF NOT EXISTS chair_photo_path VARCHAR(255) DEFAULT NULL;
